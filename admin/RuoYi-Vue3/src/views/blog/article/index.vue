<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文章标题" align="center" prop="title" show-overflow-tooltip min-width="160" />
      <el-table-column label="文章摘要" align="center" prop="summary" show-overflow-tooltip min-width="220" />
      <el-table-column label="封面图片地址" align="center" prop="coverImageUrl" show-overflow-tooltip min-width="200" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="articleRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="作者ID" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入作者ID（关联用户ID）" />
        </el-form-item>
        ...
        <el-form-item label="标签">
          <el-select v-model="form.tagIds" placeholder="请选择标签" multiple clearable>
            <el-option
        ...
        <el-form-item label="封面图片地址" prop="coverImageUrl">
          <el-input v-model="form.coverImageUrl" type="textarea" placeholder="请输入封面图片地址（URL）" />
        </el-form-item>
...
const data = reactive({
  ...
  rules: {
    ...
    allowComment: [
      { required: true, message: "允许评论不能为空", trigger: "change" }
    ],
  }
})
